...
class HDABProcessor(Processor):
    ...
    def process_dab(self, frame, run_normalize=False, scale=1.0, mn=0, mx=255, 
        ...
        if run_normalize:
            ...
            self.dab_norm = mean_normalize(dab, min_background=min_background, debug=False)
        ...
        # ax1.imshow(dab.img)
        # ax1.axis('off')
        # fig1.savefig(r'C:/Users/eteun/dev/data/AT8_tangles/morph_img.png',dpi=500)
        # plt.close()
